        ...
        <div className="p-3 border-b border-white/10">
          <div className="relative">
            ...
            <input
              ...
              className="neutralize-autofill w-full bg-white/5 text-white text-sm border border-white/10 rounded-lg pl-9 pr-8 py-2 outline-none focus:border-emerald-400"
            />
            {searchQuery && (
